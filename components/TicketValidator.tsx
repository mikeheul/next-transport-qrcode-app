...
export default function TicketValidator() {
    ...
    const previewStyle = {
        height: 500,
        width: 500,
        // Remove position from here to avoid type error
    };
    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <div className='relative flex justify-center w-full'>
                ...
                {validationResult && (
                    <div className="absolute inset-0 w-full h-full top-0 left-0 flex items-center justify-center bg-black bg-opacity-50 rounded-lg">
